...
public class SingleColumnValueFilter extends FilterBase {
  ...
  public SingleColumnValueFilter(final byte [] family, final byte [] qualifier,
	  ...
	  this(family, qualifier, compareOp, comparator,Bytes.toBytes("100"));
  }
  
  
  public SingleColumnValueFilter(final byte [] family, final byte [] qualifier,
      final CompareOp compareOp, final WritableByteArrayComparable comparator, byte[] tableDigest)
  {
